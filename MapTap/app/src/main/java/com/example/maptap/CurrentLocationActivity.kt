...
import com.example.maptap.databinding.ActivityCurrentLocationBinding
...
class CurrentLocationActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private val LOCATION_MIN_UPDATE_DISTANCE = 100
...
//                markerOptions.icon(BitmapFromVector(this, R.drawable.ic_map_event));
                markerOptions.icon(BitmapFromVector(this, R.drawable.ic_launcher_background))
            } else {
