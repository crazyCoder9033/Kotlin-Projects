...
import com.example.roomdatabase.ViewModal;
...
//                viewmodal.delete(adapter.getCourseAt(viewHolder.getAdapterPosition()));
                Toast.makeText(FirstActivity.this, "Course deleted", Toast.LENGTH_SHORT).show();
            }
        }).
        ...
        adapter.setOnItemClickListener(new CourseRVAdapter.OnItemClickListener() {
            ...
            public void onItemClick(CourseModal model) {
                ...
                Intent intent = new Intent(FirstActivity.this, MainActivity.class);
                intent.putExtra(MainActivity.EXTRA_ID, model.getId());
                intent.putExtra(MainActivity.EXTRA_COURSE_NAME, model.getCourseName());
                intent.putExtra(MainActivity.EXTRA_DESCRIPTION, model.getCourseDescription());
                intent.putExtra(MainActivity.EXTRA_DURATION, model.getCourseDuration());
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == ADD_COURSE_REQUEST && resultCode == RESULT_OK) {
            String courseName = data.getStringExtra(MainActivity.EXTRA_COURSE_NAME);
            String courseDescription = data.getStringExtra(MainActivity.EXTRA_DESCRIPTION);
            String courseDuration = data.getStringExtra(MainActivity.EXTRA_DURATION);
            ...
            String courseName = data.getStringExtra(MainActivity.EXTRA_COURSE_NAME);
            String courseDesc = data.getStringExtra(MainActivity.EXTRA_DESCRIPTION);
            String courseDuration = data.getStringExtra(MainActivity.EXTRA_DURATION);
